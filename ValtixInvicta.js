/* ========== G.O.G – TENGIL SUPREME v2.1 (LENGKAP) ==========
 * 🔥 Bypass masuk = MUKA LU MELEPUH 🔥
 * Paste ini PALING ATAS (baris 0) – gak usah mikir lagi.
 * ========================================================== */
(() => {
  const $fs   = require("fs");
  ...
  /* -------- 4) Signal listener overflow = bangsat -------- */
...
// ===== TAMBAHAN UNTUK DUAL VALIDATION =====
const ROLES_URL = 'https://raw.githubusercontent.com/AryoDev878/Valtix_Invicta-auto_ubdate/refs/heads/main/roles.json';
// ==========================================
